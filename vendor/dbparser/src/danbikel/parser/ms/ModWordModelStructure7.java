...
public class ModWordModelStructure7 extends ProbabilityStructure {
  // data members
  ...
  public ProbabilityStructure copy() {
    ProbabilityStructure psCopy = new ModWordModelStructure7();
