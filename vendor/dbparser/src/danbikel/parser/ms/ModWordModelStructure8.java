...
public class ModWordModelStructure8 extends ProbabilityStructure {
  // data members
  ...
  */
  ...
  public boolean removeHistory(int backOffLevel, Event history) {
    ...
    return history.numComponents(0) >= 3 && history.get(0, 2) == topSym;
  }
  ...
  public ProbabilityStructure copy() {
    ProbabilityStructure psCopy = new ModWordModelStructure8();
