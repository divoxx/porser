%% $Id: abnt-bibtex-alf-doc.tex,v 1.25 2003/03/28 20:54:20 gweber Exp $
...
\usepackage{html}
%\usepackage{showtags}
\usepackage[alf,abnt-repeated-title-omit=yes,abnt-show-options=warn]{abntcite}
\def\Versao$#1 #2${#2}
\def\Data$#1 #2 #3${#2}
...
\pdfinfo{
  /Title        (Estilo bibtex compativel com a `norma' 6023/2000 da ABNT: Questoes especificas da `norma' 10520/2001)
  /Author       (G. Weber - Grupo abnTeX)
  /Subject      (referencias bibliograficas)
  /Keywords     (ABNT, bibliografia, 6023/2000, 10520/2001)}
\fi
\begin{document}
...
\titulo{Estilo bibtex compatível com a `norma' 6023/2000 da ABNT:
Questões específicas da `norma' 10520/2001\\
Versão \Versao$Revision: 1.25 $}
\autor{G. Weber}
\comentario{Manual de uso do estilo bibliográficos alfabético (sistema autor-data).}
\instituicao{Grupo \abnTeX}
\data{\Data$Date: 2003/03/28 20:54:20 $}
...
\title{Estilo bibtex compatível com a `norma' 6023/2000 da ABNT:\\ Questões específicas da `norma' 10520/2001}

\author{G. Weber --- Grupo \abnTeX\\\htmladdnormallink{\tt abntex.codigolivre.org.br}{http://abntex.codigolivre.org.br}}

\date{\Data$Date: 2003/03/28 20:54:20 $}
...
quanto uma régua-de-cálculo. Você não tem absolutamente nenhum motivo para
não usar o sistema de citação numérico, já que a ABNT
``autorizou'' o seu uso por um cochilo qualquer.
...
autor-data.
Comentamos isso porque tudo isso já aconteceu com outras pessoas.
...
Embora \emph{todas} as `normas' da ABNT \cite{NBR6023:2000,NBR10520:1988,NBR10520:2001}
...
Este sistema de citação é descrito em \citeonline{NBR10520:2001}, note que
essa `norma' entrou em vigor em agosto de 2001 substituindo a
\citeonline{NBR10520:1988}.
...
A ironia será assim uma \ldots\  proposta por
\citeonline{10520:4.1-1}.
\end{verbatim}\end{minipage}\begin{minipage}[t]{7cm}\latex{\small}
A ironia será assim uma \latexhtml{\ldots\ }{...} proposta por \citeonline{10520:4.1-1}.
\end{minipage}\vspace{5mm}\\
...
\cite[p.~46, grifo nosso]{10520:4.8}  \ldots\ 
\end{verbatim}\end{minipage}\begin{minipage}[t]{7cm}\latex{\small}
para que \latexhtml{\ldots\ }{...} à sociedade \cite[p.~46, grifo nosso]{10520:4.8}  \latexhtml{\ldots\ }{...}
\end{minipage}\vspace{5mm}\\

\noindent\begin{minipage}[t]{10cm}\latex{\small}\begin{verbatim}
b) desejo de \ldots\  passado colonial
\cite[v.~2, p.~12, grifo do autor]{10520:4.8.1}
\ldots\ 
\end{verbatim}\end{minipage}\begin{minipage}[t]{7cm}\latex{\small}
b) desejo de \latexhtml{\ldots\ }{...} passado colonial
\cite[v.~2, p.~12, grifo do autor]{10520:4.8.1}  \latexhtml{\ldots\ }{...}
\end{minipage}\vspace{5mm}\\
...
foram investigados estados em fios quânticos.
\end{verbatim}\end{minipage}\begin{minipage}[t]{7cm}\latex{\small}
Em recente estudo \cite{Deng00}
foram investigados estados em fios quânticos.
\end{minipage}\vspace{5mm}\\
...
\subsection{Citar apenas o autor ({\tt citeauthoronline}), forma explícita}

\noindent\begin{minipage}[t]{10cm}\latex{\small}\begin{verbatim}
A produção de \ldots\  em 1928 mencionada por
\citeauthoronline{10520:4.2-1}.
\end{verbatim}\end{minipage}\begin{minipage}[t]{7cm}\latex{\small}
A produção de \latexhtml{\ldots\ }{...} em 1928  mencionada por
\citeauthoronline{10520:4.2-1}.
\end{minipage}\vspace{5mm}\\
...
\subsection{Citar apenas o ano ({\tt citeyear})}
...
o sobrenome+data forem igual. Isto em geral não é possível pois raramente
...
\bibliography{abnt-options,abnt-10520-2001,abnt-6023-2000,normas,abnt-test,abntex-doc}
\end{document}
