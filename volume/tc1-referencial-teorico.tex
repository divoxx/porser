...
\subsection{\emph{Corpus} para processamento de linguagem natural} % (fold)
...
\begin{table}[H]
   ...
   \begin{tabular}{ | p{5cm} | p{3cm} | p{3cm} | p{3cm} | }
      \hline
        ...
        \hline
   \end{tabular}
   \footnotemark[1]{Data refere-se ao Birmingham \emph{Corpus}, do qual o Bank of English derivou}
   \label{tbl:corpora}
\end{table}
...
%, O Bank of English é um \emph{corpus} monitor e em crescente expansão.
...
Em um dado momento este chegou a ser o \emph{corpus} escolhido para o desenvolvimento do \emph{parser}. No decorrer do desenvolvimento do trabalho mudou-se para o \emph{corpus} Floresta Sintática, que se encontra em estágio mais consolidado.
...
\subsection{\emph{Parsing} probabilístico para o português do Brasil de Andréia Gentil Bonfante} % (fold)
\label{sec:bonfante}
